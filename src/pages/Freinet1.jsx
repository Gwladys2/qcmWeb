...
import questions from '../data/grandsPedagogues/serie1.json';
...
export default function PhiloEducation() {
  ...
  return (
    <div className="quiz-container">
      ...
      {!showRestart ? (
        <>
          <Link className="link" to="/CoursFreinet1">
           📖 Voir le cours
         </Link>

          <h2 className="title">Les grands pédagogues: Célestin Freinet- Partie 1</h2>
