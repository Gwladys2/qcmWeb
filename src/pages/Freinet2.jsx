...
import questions from '../data/grandsPedagogues/serie2.json';
...
export default function PhiloEducation() {
  ...
  return (
    <div className="quiz-container">
      ...
      {!showRestart ? (
        <>
          <Link className="link" to="/CoursFreinet2">
                     📖 Voir le cours
                   </Link>

          <h2 className="title">Les grands pédagogue: Célestin Freinet- Partie 2</h2>
