...
import questions from '../data/grandsPedagogues/serie3.json';
...
export default function PhiloEducation() {
  ...
  return (
    <div className="quiz-container">
      ...
      {!showRestart ? (
        <>
          <Link className="link" to="/CoursMontessori1">
           📖 Voir le cours
         </Link>

          <h2 className="title">Les grands pédagogues: Maria Montessori- Partie 1</h2>
