...
import questions from '../data/grandsPedagogues/serie5.json';
...
export default function PhiloEducation() {
  ...
  return (
    <div className="quiz-container">
      ...
      {!showRestart ? (
        <>
          <Link className="link" to="/CoursNeill1">
           📖 Voir le cours
         </Link>

          <h2 className="title">Les grands pédagogues:Alexander S. Neill- Partie 1</h2>
